...
const activity =
  ...
  " i dati delle ricerche degli utenti per vendere a negozi fisici analisi di interesse dei singoli utenti. Il modello è tale per cui a un qualsiasi cliente che entra in un negozio fisico " +
